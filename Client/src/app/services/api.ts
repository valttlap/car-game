...
export class PlateClient {
    ...
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_BASE_URL) baseUrl?: string) {
        this.http = http;
        this.baseUrl = baseUrl ?? "https://localhost:7235";
    }
...
export class SightingClient {
     ...
     * GetCountrySightings
     */
    getCountrySightings(httpContext?: HttpContext): Observable<SightingUserDto[]> {
        let url_ = this.baseUrl + "/api/Sighting/country";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCountrySightings(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCountrySightings(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<SightingUserDto[]>;
                }
            } else
    ...
    protected processGetCountrySightings(response: HttpResponseBase): Observable<SightingUserDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    /**
     * GetDiplomatSightings
     */
    getDiplomatSightings(httpContext?: HttpContext): Observable<SightingUserDto[]> {
        let url_ = this.baseUrl + "/api/Sighting/diplomat";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetDiplomatSightings(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetDiplomatSightings(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<SightingUserDto[]>;
                }
            } else
    ...
    protected processGetDiplomatSightings(response: HttpResponseBase): Observable<SightingUserDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * DeleteSighting
     */
    deleteSighting(id: number, httpContext?: HttpContext): Observable<void> {
        let url_ = this.baseUrl + "/api/Sighting/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteSighting(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteSighting(response_ as any);
                } catch (e) {
    ...
    protected processDeleteSighting(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
