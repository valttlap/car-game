    ...
    private static int Main(string[] args)
    {
        try
        {
            if (args.Length <= 1)
            {
                ...
                Console.WriteLine("\"Server=127.0.0.1;Port=5432;Database=car_game;Integrated Security=true;\"");
                Console.WriteLine("\"Server=127.0.0.1;Port=5432;Database=car_game;User Id=myUsername;Password=myPassword;\"");
                Console.WriteLine("");
